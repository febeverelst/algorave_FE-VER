...
- The installation process *appeared* to complete successfully  
- All required software seemed to be installed  
- However, when attempting to start TidalCycles, I consistently encountered errors

### Issues Encountered
- The program fails to start properly
- Multiple error messages appear on launch
- According to ChatGPT, the issue might be related to **too many files loading at once**
- Despite multiple attempts, I was unable to resolve the issue
...
- Complex audio toolchains  
- Real-time systems  
- Non-trivial installation errors  

> **Personal note:**  
> *ChatGPT (and other AI tools) have absolutely no rhythm.*  
>  
...
- AI tools are helpful for orientation, but not a replacement for:
  - community knowledge
